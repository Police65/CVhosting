...
const qrCodeUrl = "https://nkwlaqmbnaftpykkkhss.supabase.co/storage/v1/object/sign/images/qr_code.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV8yNjJmZjYwZi1kZGZlLTQzZDAtOTNhZi0xYzNiYjJkZjgwMzUiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJpbWFnZXMvX3JfY29kZS5wbmciLCJpYXQiOjE3NTcwMzQzNDIsImV4cCI6MTg0MzQzNDM0Mn0.uO2ekO1IzB_NoEq_x-zrvwShGpyUs1wUi-DoHCQXzd4";
                    ...
                    <div className="mt-10">
                        ...
                        <div className="flex flex-wrap">
                            {[...data.skills.strong, ...data.skills.basic].map(skill => (
                                <span key={skill} className="inline-block bg-slate-600 text-slate-100 text-xs font-medium px-2 py-1 rounded mr-2 mb-2 leading-none">{skill}</span>
                            ))}
                        </div>
                    </div>
